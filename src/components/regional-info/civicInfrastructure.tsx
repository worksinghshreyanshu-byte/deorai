  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-24">
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="rounded-3xl border border-[#D7C3AC] bg-[#F8F1E8] p-10 transition-all duration-300 hover:border-[#C8AF93]">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <h3 className="mt-1 font-serif text-2xl text-brand">
                {transportation.rail.nearestStation}
              </h3>
            </div>
          </div>

          <div className="my-8 h-px bg-[#E4D6C7]" />
        ...
        <div className="rounded-3xl border border-[#D7C3AC] bg-[#F8F1E8] p-10 transition-all duration-300 hover:border-[#C8AF93]">
          ...
          <div className="space-y-5">
            {pollingStations.map((station, index) => (
              ...
              >
                <span className="text-lg text-[#5E4634]">{station}</span>
